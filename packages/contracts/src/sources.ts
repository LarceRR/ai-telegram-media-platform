...
export const sourceResponseSchema = z.object({
  id: z.string().uuid(), channelId: z.string().uuid(), name: z.string(), type: sourceTypeSchema,
  url: z.string().url(), status: sourceStatusSchema, priority: z.number().int(),
  lastIngestedAt: z.string().datetime().nullable(), lastHealthStatus: z.string().nullable(),
});
export type SourceResponse = z.infer<typeof sourceResponseSchema>;

export { jobEnvelopeSchema } from './jobs';
