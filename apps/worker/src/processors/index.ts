...
import { JOB_NAMES, JOB_NAMES_SOURCES, JOB_NAMES_CONTENT } from '@atmp/contracts';
...
import { contentDiscoveryProcessor } from './content-discovery.processor';
export interface ProcessorContext { context: INestApplicationContext; logger: Logger; }
...
export const PROCESSORS: Record<QueueName, Record<string, JobHandler>> = {
  ...
  'content-intelligence': { [JOB_NAMES_CONTENT.discoverIdeas]: contentDiscoveryProcessor },
  research: {}, 'generation-validation': {}, media: {}, publishing: {}, analytics: {}, optimization: {},
