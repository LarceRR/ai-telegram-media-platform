...
export { SAFE_HTTP_CLIENT, SOURCE_ADAPTERS } from './modules/sources/infrastructure/source.tokens';
...
export { classifyCandidate, type ClassificationContext, type ExactMatch, type MemoryCandidate, type MemoryNeighbour } from './modules/memory/domain/memory-classifier';
export { cosineSimilarity, similarityFromDistance, type EmbeddingProvider, type EmbeddingVector } from './modules/memory/domain/embedding';
export { ContentIntelligenceModule } from './modules/content-intelligence/content-intelligence.module';
export { DiscoveryService } from './modules/content-intelligence/application/discovery.service';
