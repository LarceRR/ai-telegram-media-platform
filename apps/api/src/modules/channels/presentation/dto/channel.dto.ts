...
export class UpdateSettingsDto {
  ...
  @IsOptional() @IsInt() @Min(0) @Max(100000) minLength?: number;
  @IsOptional() @IsInt() @Min(1) @Max(100000) maxLength?: number;
  @IsOptional() @IsBoolean() emojiEnabled?: boolean;
  ...
  @IsOptional() @IsObject() sourcePriorities?: Record<string, number>;
